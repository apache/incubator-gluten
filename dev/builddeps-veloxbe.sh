...
function build_gluten_cpp {
  ...
  cmake -DBUILD_VELOX_BACKEND=ON -DCMAKE_BUILD_TYPE=$BUILD_TYPE \
        ...
        -DBUILD_TESTS=$BUILD_TESTS -DBUILD_EXAMPLES=$BUILD_EXAMPLES -DBUILD_BENCHMARKS=$BUILD_BENCHMARKS \
        -DENABLE_JEMALLOC=$ENABLE_JEMALLOC -DENABLE_JEMALLOC_STATS=$ENABLE_JEMALLOC_STATS \
