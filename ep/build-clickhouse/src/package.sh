...
mvn clean install -Pbackends-clickhouse -Pspark-3.2 -Pceleborn -Puniffle -DskipTests -Dcheckstyle.skip
...
mvn clean install -Pbackends-clickhouse -Pspark-3.3 -Pceleborn -Puniffle -DskipTests -Dcheckstyle.skip
