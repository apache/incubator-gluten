...
function compile {
    scripts/setup-ubuntu.sh
    make release EXTRA_CMAKE_FLAGS="-DVELOX_ENABLE_PARQUET=ON -DVELOX_BUILD_TESTING=OFF -DVELOX_ENABLE_DUCKDB=OFF -DVELOX_BUILD_TEST_UTILS=ON -DVELOX_ENABLE_S3=ON -DVELOX_ENABLE_HIVE_CONNECTOR=ON"
}
