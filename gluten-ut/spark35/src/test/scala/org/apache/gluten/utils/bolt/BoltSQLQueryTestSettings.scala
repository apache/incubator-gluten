...
object BoltSQLQueryTestSettings extends SQLQueryTestSettings {
  override def getResourceFilePath: String =
    getClass.getResource("/").getPath + "../../../src/test/resources/backends-bolt/sql-tests"
  ...
  override def getIgnoredSQLQueryTests: List[String] = List(
    "charvarchar.sql",
    "datetime-legacy.sql",
  ...
  val OVERWRITE_SQL_QUERY_LIST: Set[String] = Set(
    // The calculation formulas for corr, skewness, kurtosis, variance, and stddev in Bolt differ
