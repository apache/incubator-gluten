...
class GlutenSQLQueryTestSuite extends QueryTest with SharedSparkSession with SQLHelper
  ...
  private val veloxSupportedList: Set[String] = Set(
    ...
    "exists-aggregate.sql",
    "exists-basic.sql",
    "exists-cte.sql",
    "exists-having.sql",
    "exists-joins-and-set-ops.sql",
    "exists-orderby-limit.sql",
    "exists-within-and-or.sql",
    "in-basic.sql",
    "in-group-by.sql",
    "in-having.sql",
    // "in-joins.sql",
    ...
    "not-in-group-by.sql",
    "not-in-joins.sql",
    "not-in-unit-tests-multi-column-literal.sql",
    "not-in-unit-tests-multi-column.sql",
    "not-in-unit-tests-single-column-literal.sql",
    "not-in-unit-tests-single-column.sql",
    "simple-in.sql",
    "invalid-correlation.sql",
    "subq-input-typecheck.sql",
