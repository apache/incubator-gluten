...
class GlutenParquetThriftCompatibilitySuite extends ParquetThriftCompatibilitySuite
  with GlutenSQLTestsBaseTrait {

  private val parquetFilePath = getWorkspaceFilePath(
    "sql", "core", "src", "test", "resources").toString +
