...
class GlutenParquetRebaseDatetimeV1Suite extends ParquetRebaseDatetimeV1Suite
...
class GlutenParquetRebaseDatetimeV2Suite extends ParquetRebaseDatetimeV2Suite
  with GlutenSQLTestsBaseTrait {
