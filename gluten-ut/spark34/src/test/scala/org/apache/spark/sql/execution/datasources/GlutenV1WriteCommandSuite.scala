...
class GlutenV1WriteCommandSuite extends V1WriteCommandSuite with GlutenSQLTestsBaseTrait {
  ...
  test(GlutenTestConstants.GLUTEN_TEST + "SPARK-41914: v1 write with AQE and in-partition sorted - non-string partition column") {
  ...
  test(GlutenTestConstants.GLUTEN_TEST +"SPARK-41914: v1 write with AQE and in-partition sorted - string partition column") {
