...
import org.apache.spark.sql.catalyst.expressions.{Attribute, BinaryExpression, Cast, Expression}
...
trait SparkShims {
  ...
  /** Shim method to determine failure behaviour for Cast */
  def ansiEnabled(original: Cast): Boolean
}
