...
public class FlinkRowToVLVectorConvertor {
  ...
  public static RowVector fromRowData(
    ...
    for (int i = 0; i < rowType.size(); i++) {
      ...
      if (fieldType instanceof IntegerType) {
        ...
        // TODO: refine this
        StructVector structVector = StructVector.empty(rowType.getNames().get(i), allocator);
        ...
        if (subRow != null) {
          for (int j = 0; j < subRowType.size(); j++) {
            ...
            if (subFieldType instanceof IntegerType) {
              ...
              timestampVector.setSafe(0, subRow.getTimestamp(j, 3).getMillisecond());
  ...
  public static List<RowData> toRowData(
    ...
    final FieldVector fieldVector = Arrow.toArrowVector(allocator, loadedVector);
