...
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(StdDev, stddev, stddevSampStable)
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(StdDevSamp, stddev_samp, stddevSampStable)
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(StdDevPop, stddev_pop, stddevPopStable)
...
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(CovarPop, covar_pop, covarPopStable)
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(CovarSamp, covar_samp, covarSampStable)
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(VarSamp, var_samp, varSampStable)
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(VarPop, var_pop, varPopStable)
REGISTER_COMMON_AGGREGATE_FUNCTION_PARSER(Corr, corr, corrStable)
