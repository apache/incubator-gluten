...
class FunctionParserXxHash64 : public FunctionParser
{
public:
    explicit FunctionParserXxHash64(SerializedPlanParser * plan_parser_) : FunctionParser(plan_parser_) { }
        ...
        ActionsDAGPtr & actions_dag) const override
    {
        ...
        const auto * hash_node = toFunctionNode(actions_dag, "xxHashSpark64", parsed_args);
        return convertNodeTypeIfNeeded(substrait_func, hash_node, actions_dag);
    }
};

static FunctionParserRegister<FunctionParserXxHash64> register_xxhash64;
}
