...
void DeltaReader::deleteRowsByDV(Chunk & chunk) const
{
    ...
    size_t deleted_row_pos = outputHeader.getPositionByName(DeltaParquetVirtualMeta::DELTA_INTERNAL_IS_ROW_DELETED);
    DB::DataTypePtr deleted_row_type = DeltaParquetVirtualMeta::getMetaColumnType(outputHeader);
