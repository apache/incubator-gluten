...
TEST(WritePipeline, SparkMergeTree)
{
    ...
    const auto merge_tree_table = MergeTreeRelParser::parseMergeTreeTable(extension_table);
    ...
    ///
    {
        ...
        const auto merge_tree_table_hdfs = MergeTreeRelParser::parseMergeTreeTable(extension_table_hdfs);
