...
3.4)
    # Spark-3.4
    cd ${INSTALL_DIR} && \
    wget -nv https://archive.apache.org/dist/spark/spark-3.4.4/spark-3.4.3-bin-hadoop3.tgz && \
    tar --strip-components=1 -xf spark-3.4.4-bin-hadoop3.tgz spark-3.4.3-bin-hadoop3/jars/ && \
