...
IcebergWriter::IcebergWriter(
  ...
  auto connectorSessionProperties_ = getConnectorSessionConfig(*veloxCfg_);
  connectorConfig_ = std::make_shared<facebook::velox::connector::hive::HiveConfig>(getHiveConfig(veloxCfg_));
