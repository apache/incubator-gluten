...
struct SchemaExportTraits {
  ...
  static constexpr auto IsReleasedFunc = &VeloxArrowSchemaIsReleased;
  static constexpr auto ReleaseFunc = &VeloxArrowSchemaRelease;
};

struct ArrayExportTraits {
  typedef struct ArrowArray CType;
  static constexpr auto IsReleasedFunc = &VeloxArrowArrayIsReleased;
  static constexpr auto ReleaseFunc = &VeloxArrowArrayRelease;
};

struct ArrayStreamExportTraits {
  typedef struct ArrowArrayStream CType;
  static constexpr auto IsReleasedFunc = &VeloxArrowArrayStreamIsReleased;
  static constexpr auto ReleaseFunc = &VeloxArrowArrayStreamRelease;
};
