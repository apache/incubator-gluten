...
import org.apache.spark.shuffle.{ColumnarShuffleDependency, GlutenShuffleUtils, ShuffleWriteMetricsReporter, ShuffleWriter}
...
class CelebornHashBasedCHColumnarShuffleWriter[K, V](
  ...
  private val celebornPartitionPusher = new CelebornCHPartitionPusher(
    shuffleId,
    numMappers,
    numPartitions,
    context,
