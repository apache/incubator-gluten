...
abstract class MergeTreeBaseDynamicPartitionDataWriter(
  ...
  protected val isBucketed: Boolean = description.bucketIdExpression.isDefined
  ...
  protected lazy val getBucketId: InternalRow => Int = {
    val proj =
      UnsafeProjection.create(Seq(description.bucketIdExpression.get), description.allColumns)
