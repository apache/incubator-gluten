...
class GlutenClickHouseCollectLimitExecSuite extends GlutenClickHouseWholeStageTransformerSuite {
  ...
  testWithSpecifiedSparkVersion("ColumnarCollectLimitExec - basic limit test", Array("3.3")) {
  ...
  testWithSpecifiedSparkVersion("ColumnarCollectLimitExec - with filter", Array("3.3")) {
    val df = spark
      .range(0, 20, 1)
      .toDF("id")
      .filter("id % 2 == 0")
  ...
  testWithSpecifiedSparkVersion("ColumnarCollectLimitExec - range with repartition", Array("3.3")) {
    val df = spark
      .range(0, 10, 1)
      .toDF("id")
      .repartition(3)
  ...
  testWithSpecifiedSparkVersion("ColumnarCollectLimitExec - with distinct values", Array("3.3")) {
    val df = spark
      .range(0, 10, 1)
      .toDF("id")
      .select("id")
  ...
  testWithSpecifiedSparkVersion("ColumnarCollectLimitExec - chained limit", Array("3.3")) {
    val df = spark
      .range(0, 10, 1)
      .toDF("id")
      .limit(8)
  ...
  testWithSpecifiedSparkVersion("ColumnarCollectLimitExec - limit after union", Array("3.3")) {
