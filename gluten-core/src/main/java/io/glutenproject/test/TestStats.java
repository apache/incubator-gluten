...
public class TestStats {
    ...
    public static void printMarkdown(String suitName) {
        ...
        System.out.println(
                "total_markdown_ totalCaseNum:" + totalSuiteTestNumber
                        + " offloadGluten: " + totalOffloadGlutenTestNumber
                        + " total unit: " + totalTestUnitNumber
                        + " offload unit: " + totalOffloadGlutenCaseNumber);
    }
