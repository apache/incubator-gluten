 ...
 * @param serializer             [[org.apache.spark.serializer.Serializer Serializer]] to use.
 *                               If not set explicitly then the default serializer,
 *                               as specified by `spark.serializer`
