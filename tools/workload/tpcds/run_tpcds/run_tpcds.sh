...
cat tpcds_parquet.scala | ${SPARK_HOME}/bin/spark-shell \
  ...
  #   --jars /PATH_TO_GLUTEN_HOME/dist/gluten-thirdparty-lib-ubuntu-22.04-x86_64.jar,
  #          /PATH_TO_GLUTEN_HOME/dist/gluten-velox-bundle-spark3.3_2.12-ubuntu_22.04_x86_64-1.2.0-SNAPSHOT.jar
