...
Once building successfully, the Jar file will be generated in the directory: package/target/gluten-spark3.2_2.12-0.5.0-SNAPSHOT-jar-with-dependencies.jar for Spark 3.2.2, and package/target/gluten-spark3.3_2.12-0.5.0-SNAPSHOT-jar-with-dependencies.jar for Spark 3.3.1.
