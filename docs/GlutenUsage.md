...
spark.driver.extraClassPath ${GLUTEN_HOME}/jvm/target/gluten-<version>-snapshot-jar-with-dependencies.jar
spark.executor.extraClassPath ${GLUTEN_HOME}/jvm/target/gluten-<version>-snapshot-jar-with-dependencies.jar
```
