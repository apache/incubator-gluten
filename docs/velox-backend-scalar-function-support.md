...
**Out of 357 scalar functions in Spark 3.5, Gluten currently fully supports 241 functions and partially supports 21 functions.**
...
| Spark Functions   | Spark Expressions   | Status   | Restrictions                                     |
|-------------------|---------------------|----------|--------------------------------------------------|
| from_json         | JsonToStructs       | PS       | from_json with options is not supported in Velox |
