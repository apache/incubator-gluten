...
import com.intel.oap.spark.sql.DwrfWriteExtension.DwrfWritePostRule
import com.intel.oap.spark.sql.DwrfWriteExtension.DummyRule
import com.intel.oap.spark.sql.DwrfWriteExtension.SimpleColumnarRule
import com.intel.oap.spark.sql.DwrfWriteExtension.SimpleStrategy
