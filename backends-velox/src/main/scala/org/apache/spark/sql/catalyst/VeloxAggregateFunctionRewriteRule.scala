...
import org.apache.spark.sql.catalyst.expressions.aggregate.{AggregateExpression, HLLVeloxAdapter, HyperLogLogPlusPlus}
...
case class VeloxAggregateFunctionRewriteRule(spark: SparkSession) extends Rule[LogicalPlan] {
