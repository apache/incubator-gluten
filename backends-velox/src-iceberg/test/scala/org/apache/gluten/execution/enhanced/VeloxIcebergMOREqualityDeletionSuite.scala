...
import org.apache.gluten.execution.{IcebergScanTransformer, WholeStageTransformerSuite}
...
class VeloxIcebergMOREqualityDeletionSuite extends WholeStageTransformerSuite {
  ...
  test("iceberg read mor table with equality deletion") {
